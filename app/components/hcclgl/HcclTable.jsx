...
import {timeStampToStringHHmm} from '../../utils/DateUtils'
 ...
 * 身份证查询的表格
 */
class HcclTable extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{'position':'relative'}}>
                <MaterialTable topTitle={TABLE_TOPTITLE} titleNames={TABLE_TITLES} data={page.list}
...
export default connect(
    (state, ownProps) => ({
        ...
        form: state.hcclgl_redux.form,
        alert: state.hcclgl_redux.alert,
        snack: state.hcclgl_redux.snack,
        loading: state.hcclgl_redux.loading,
